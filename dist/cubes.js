...
define(['three', 'TrackballControls'], function (_three) {
  ...
  var Animation = function () {
    function Animation() {
      ...
      this.cubes = new _three2.default.Group();
      this.allVertices = [];
    }
    ...
    _createClass(Animation, [{
      ...
      value: function init() {
        ...
        // Camera
        this.camera = new _three2.default.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 1, 1000);
        ...
        // Lights
        var directionalLight = new _three2.default.DirectionalLight(0xffffff, 0.7);
        directionalLight.position.set(0, 0.5, 1);
        this.scene.add(directionalLight);

        var AmbientLight = new _three2.default.AmbientLight(0x777777);
        ...
        for (var i = 0; i < CUBES_NUM; i++) {
          ...
          var cube = new _three2.default.Group();

          // Positions for the vertices
          var hidden = new _three2.default.BoxGeometry(10, 10, 10);
          var positions = hidden.vertices;

          // Vertices of the cube
          var cubeVertices = new _three2.default.Group();

          // Eight spheres in the loop
          for (var _i = 0; _i < positions.length; _i++) {
            var geometry1 = new _three2.default.SphereGeometry(1, 16, 16);

            // Random colors
            var material1 = new _three2.default.MeshPhongMaterial({ color: Math.random() * 0xffffff });
            var sphere = new _three2.default.Mesh(geometry1, material1);
          ...
          var geometry2 = new _three2.default.CylinderGeometry(0.5, 0.5, 10, 32);
          var material2 = new _three2.default.MeshPhongMaterial({ color: 0x777777 });

          var cylinder = new _three2.default.Mesh(geometry2, material2); // 1
          cylinder.translateX(5);
          cylinder.translateZ(5);
          var edgesY = new _three2.default.Group();
          edgesY.add(cylinder);
